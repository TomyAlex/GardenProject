...
int resetButton = 2; // Button for reset screen
int pin12 = 12; // Port 1 Relay connected to pump1
int pin13 = 13; // Port 2 Relay connected to pump2
...
void countingDownClosedChannel() {
  ...
  while (timerClosed != 0) {
    ...
    // Verifying butttonState in case if screen become instable
